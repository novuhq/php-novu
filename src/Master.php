...
class Master
{
    ...
    public function retrieve(?string $locale = null, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerGetMasterJsonEndpointResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_getMasterJsonEndpoint', [], $this->sdkConfiguration->securitySource);
    ...
    public function import(Components\ImportMasterJsonRequestDto $importMasterJsonRequestDto, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerImportMasterJsonEndpointResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_importMasterJsonEndpoint', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function upload(?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerUploadMasterJsonEndpointResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_uploadMasterJsonEndpoint', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

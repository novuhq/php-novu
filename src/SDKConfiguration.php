...
class SDKConfiguration
{
    ...
    public string $openapiDocVersion = '3.17.1';

    public string $sdkVersion = '3.18.0';

    public string $genVersion = '2.913.3';

    public string $userAgent = 'speakeasy-sdk/php 3.18.0 2.913.3 3.17.1 novuhq/novu';

...
class Authentication
{
     ...
     */
    public function handleOauthCallback(Operations\SubscribersV1ControllerChatOauthCallbackRequest $request, ?Options $options = null): Operations\SubscribersV1ControllerChatOauthCallbackResponse
    {
        $retryConfig = null;
        if ($options) {

...
class NovuMessages
{
    ...
    public function updateAsSeen(Operations\SubscribersV1ControllerMarkActionAsSeenRequest $request, ?Options $options = null): Operations\SubscribersV1ControllerMarkActionAsSeenResponse
    {
        ...
        $hookContext = new HookContext('SubscribersV1Controller_markActionAsSeen', null, $this->sdkConfiguration->securitySource);
    ...
    public function markAll(Components\MarkAllMessageAsRequestDto $markAllMessageAsRequestDto, string $subscriberId, ?string $idempotencyKey = null, ?Options $options = null): Operations\SubscribersV1ControllerMarkAllUnreadAsReadResponse
    {
        ...
        $request = new Operations\SubscribersV1ControllerMarkAllUnreadAsReadRequest(
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext('SubscribersV1Controller_markAllUnreadAsRead', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\SubscribersV1ControllerMarkAllUnreadAsReadResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    headers: $httpResponse->getHeaders(),
    ...
    public function markAllAs(Components\MessageMarkAsRequestDto $messageMarkAsRequestDto, string $subscriberId, ?string $idempotencyKey = null, ?Options $options = null): Operations\SubscribersV1ControllerMarkMessagesAsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext('SubscribersV1Controller_markMessagesAs', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

...
class Preferences
{
    ...
    public function bulkUpdate(Components\BulkUpdateSubscriberPreferencesDto $bulkUpdateSubscriberPreferencesDto, string $subscriberId, ?string $idempotencyKey = null, ?Options $options = null): Operations\SubscribersControllerBulkUpdateSubscriberPreferencesResponse
    {
        ...
        $request = new Operations\SubscribersControllerBulkUpdateSubscriberPreferencesRequest(
            subscriberId: $subscriberId,
            bulkUpdateSubscriberPreferencesDto: $bulkUpdateSubscriberPreferencesDto,
            idempotencyKey: $idempotencyKey,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/subscribers/{subscriberId}/preferences/bulk', Operations\SubscribersControllerBulkUpdateSubscriberPreferencesRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'bulkUpdateSubscriberPreferencesDto', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'SubscribersController_bulkUpdateSubscriberPreferences', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, 'array<\novu\Models\Components\GetPreferencesResponseDto>', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\SubscribersControllerBulkUpdateSubscriberPreferencesResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    headers: $httpResponse->getHeaders(),
                    getPreferencesResponseDtos: $obj);

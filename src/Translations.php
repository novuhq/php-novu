...
class Translations
{
    ...
    public function create(Components\CreateTranslationRequestDto $createTranslationRequestDto, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerCreateTranslationEndpointResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_createTranslationEndpoint', [], $this->sdkConfiguration->securitySource);
    ...
    public function delete(Operations\TranslationControllerDeleteTranslationEndpointPathParamResourceType $resourceType, string $resourceId, string $locale, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerDeleteTranslationEndpointResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_deleteTranslationEndpoint', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function retrieve(Operations\PathParamResourceType $resourceType, string $resourceId, string $locale, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerGetSingleTranslationResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_getSingleTranslation', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function upload(Components\UploadTranslationsRequestDto $uploadTranslationsRequestDto, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerUploadTranslationFilesResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_uploadTranslationFiles', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

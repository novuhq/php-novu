...
class Stats
{
     ...
     */
    public function graph(?float $days = null, ?string $idempotencyKey = null, ?Options $options = null): Operations\NotificationsControllerGetActivityGraphStatsResponse
    {
        $retryConfig = null;
        if ($options) {
     ...
     * @throws \novu\Models\Errors\APIException
     */
    public function retrieve(?string $idempotencyKey = null, ?Options $options = null): Operations\NotificationsControllerGetActivityStatsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;

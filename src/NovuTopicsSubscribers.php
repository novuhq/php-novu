...
class NovuTopicsSubscribers
{
     ...
     */
    public function check(string $externalSubscriberId, string $topicKey, ?Options $options = null): Operations\TopicsControllerGetTopicSubscriberResponse
    {
        $retryConfig = null;
        if ($options) {
     ...
     * @throws \novu\Models\Errors\APIException
     */
    public function remove(Components\RemoveSubscribersRequestDto $removeSubscribersRequestDto, string $topicKey, ?Options $options = null): Operations\TopicsControllerRemoveSubscribersResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $hookContext = new HookContext('TopicsController_removeSubscribers', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

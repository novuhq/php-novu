...
class Groups
{
    ...
    public function delete(Operations\ResourceType $resourceType, string $resourceId, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerDeleteTranslationGroupEndpointResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_deleteTranslationGroupEndpoint', [], $this->sdkConfiguration->securitySource);
    ...
    public function retrieve(Operations\TranslationControllerGetTranslationGroupEndpointPathParamResourceType $resourceType, string $resourceId, ?string $idempotencyKey = null, ?Options $options = null): Operations\TranslationControllerGetTranslationGroupEndpointResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'TranslationController_getTranslationGroupEndpoint', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

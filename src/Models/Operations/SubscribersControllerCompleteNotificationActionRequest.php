...
class SubscribersControllerCompleteNotificationActionRequest
{
    /**
     ...
     *
     * @var \novu\Models\Operations\ActionType $actionType
     */
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $notificationId, ActionType $actionType, ?array $contextKeys = null, ?string $idempotencyKey = null)
    {

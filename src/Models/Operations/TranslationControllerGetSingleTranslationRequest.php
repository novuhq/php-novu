...
class TranslationControllerGetSingleTranslationRequest
{
    /**
     * Resource type
     *
     ...
     * @phpstan-pure
     */
    public function __construct(PathParamResourceType $resourceType, string $resourceId, string $locale, ?string $idempotencyKey = null)
    {

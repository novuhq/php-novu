...
class SubscribersControllerChatOauthCallbackRequest
{
    /**
     *
     ...
     */
    public function __construct(string $subscriberId, mixed $providerId, string $hmacHash, string $environmentId, string $code, ?string $integrationIdentifier = null)
    {

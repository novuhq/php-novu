...
class SubscribersV1ControllerMarkMessagesAsRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, Components\MessageMarkAsRequestDto $messageMarkAsRequestDto, ?string $idempotencyKey = null)
    {

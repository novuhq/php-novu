...
class SubscribersControllerGetSubscriberNotificationsCountRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $filters, ?string $idempotencyKey = null)
    {

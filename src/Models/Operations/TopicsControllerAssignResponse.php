...
class TopicsControllerAssignResponse
{
    ...
    /**
     *
     * @var ?Components\AssignSubscriberToTopicDto $assignSubscriberToTopicDto
     */
    public ?Components\AssignSubscriberToTopicDto $assignSubscriberToTopicDto = null;
    ...
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\AssignSubscriberToTopicDto $assignSubscriberToTopicDto = null, ?array $headers = [])
    {
        ...
        $this->assignSubscriberToTopicDto = $assignSubscriberToTopicDto;
    }
}
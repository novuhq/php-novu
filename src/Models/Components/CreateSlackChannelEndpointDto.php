...
class CreateSlackChannelEndpointDto
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateSlackChannelEndpointDtoType $type, SlackChannelEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

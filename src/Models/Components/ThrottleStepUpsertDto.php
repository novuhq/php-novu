...
class ThrottleStepUpsertDto
{
    ...
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ThrottleControlDto|array|null $controlValues = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $name, StepTypeEnum $type, ?string $id = null, ThrottleControlDto|array|null $controlValues = null)
    {
        $this->name = $name;
        $this->type = $type;
        $this->id = $id;

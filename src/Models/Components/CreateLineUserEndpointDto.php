...
class CreateLineUserEndpointDto
{
    /**
     ...
     *
     * @var \novu\Models\Components\CreateLineUserEndpointDtoType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\CreateLineUserEndpointDtoType')]
    public CreateLineUserEndpointDtoType $type;

    /**
     * LINE user endpoint data
     *
     * @var \novu\Models\Components\LineUserEndpointDto $endpoint
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('endpoint')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\LineUserEndpointDto')]
    public LineUserEndpointDto $endpoint;
     ...
     * $context
     *
     * @var ?array<string, string|\novu\Models\Components\CreateLineUserEndpointDtoContext2> $context
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('context')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, string|\novu\Models\Components\CreateLineUserEndpointDtoContext2>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateLineUserEndpointDtoType $type, LineUserEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

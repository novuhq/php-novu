...
class InAppStepResponseDto
{
    ...
    public InAppControlsMetadataResponseDto $controls;
     ...
     * Slug of the step
     *
     * @var InAppStepResponseDtoSlug $slug
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('slug')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\InAppStepResponseDtoSlug')]
    public InAppStepResponseDtoSlug $slug;
    ...
    public ?InAppStepResponseDtoControlValues $controlValues = null;
     ...
     * @param  string  $id
     * @param  string  $name
     * @param  InAppStepResponseDtoSlug  $slug
     ...
     * @phpstan-pure
     */
    public function __construct(InAppControlsMetadataResponseDto $controls, array $variables, string $stepId, string $id, string $name, InAppStepResponseDtoSlug $slug, StepTypeEnum $type, WorkflowOriginEnum $origin, string $workflowId, string $workflowDatabaseId, ?InAppStepResponseDtoControlValues $controlValues = null, ?StepIssuesDto $issues = null)
    {

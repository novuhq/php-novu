...
class CreatePhoneEndpointDto
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreatePhoneEndpointDtoType $type, PhoneEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

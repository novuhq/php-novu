...
class CreateWebexRoomEndpointDto
{
    /**
     ...
     *
     * @var \novu\Models\Components\CreateWebexRoomEndpointDtoType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\CreateWebexRoomEndpointDtoType')]
    public CreateWebexRoomEndpointDtoType $type;

    /**
     * Webex room endpoint data
     *
     * @var \novu\Models\Components\WebexRoomEndpointDto $endpoint
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('endpoint')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\WebexRoomEndpointDto')]
    public WebexRoomEndpointDto $endpoint;
     ...
     * $context
     *
     * @var ?array<string, string|\novu\Models\Components\CreateWebexRoomEndpointDtoContext2> $context
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('context')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, string|\novu\Models\Components\CreateWebexRoomEndpointDtoContext2>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateWebexRoomEndpointDtoType $type, WebexRoomEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

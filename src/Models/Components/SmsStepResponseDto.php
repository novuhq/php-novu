...
class SmsStepResponseDto
{
     ...
     * @phpstan-pure
     */
    public function __construct(SmsControlsMetadataResponseDto $controls, array $variables, string $stepId, string $id, string $name, SmsStepResponseDtoSlug $slug, StepTypeEnum $type, WorkflowOriginEnum $origin, string $workflowId, string $workflowDatabaseId, ?SmsStepResponseDtoControlValues $controlValues = null, ?StepIssuesDto $issues = null)
    {

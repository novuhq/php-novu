...
class CreateGrafanaOnCallIntegrationEndpointDto
{
    /**
     ...
     *
     * @var \novu\Models\Components\CreateGrafanaOnCallIntegrationEndpointDtoType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\CreateGrafanaOnCallIntegrationEndpointDtoType')]
    public CreateGrafanaOnCallIntegrationEndpointDtoType $type;
     ...
     *
     * @var \novu\Models\Components\GrafanaOnCallIntegrationEndpointDto $endpoint
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('endpoint')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\GrafanaOnCallIntegrationEndpointDto')]
    public GrafanaOnCallIntegrationEndpointDto $endpoint;
     ...
     * $context
     *
     * @var ?array<string, string|\novu\Models\Components\CreateGrafanaOnCallIntegrationEndpointDtoContext2> $context
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('context')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, string|\novu\Models\Components\CreateGrafanaOnCallIntegrationEndpointDtoContext2>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateGrafanaOnCallIntegrationEndpointDtoType $type, GrafanaOnCallIntegrationEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

...
class LayoutResponseDto
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $layoutId, string $slug, string $name, bool $isDefault, bool $isTranslationEnabled, string $updatedAt, string $createdAt, ResourceOriginEnum $origin, ResourceTypeEnum $type, LayoutControlsDto $controls, ?UpdatedBy $updatedBy = null, ?array $variables = null)
    {
        $this->id = $id;

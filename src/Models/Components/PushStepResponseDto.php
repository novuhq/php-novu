...
class PushStepResponseDto
{
    ...
    public PushControlsMetadataResponseDto $controls;
    ...
    public ?PushStepResponseDtoControlValues $controlValues = null;

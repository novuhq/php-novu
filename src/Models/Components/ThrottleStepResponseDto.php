...
class ThrottleStepResponseDto
{
     ...
     *
     * @var ThrottleControlsMetadataResponseDto $controls
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controls')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\ThrottleControlsMetadataResponseDto')]
    public ThrottleControlsMetadataResponseDto $controls;
     ...
     *
     * @var ?ThrottleStepResponseDtoControlValues $controlValues
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controlValues')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\ThrottleStepResponseDtoControlValues|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?ThrottleStepResponseDtoControlValues $controlValues = null;
    ...
    /**
     * @param  ThrottleControlsMetadataResponseDto  $controls
     ...
     * @param  ?ThrottleStepResponseDtoControlValues  $controlValues
     * @param  ?StepIssuesDto  $issues
     * @param  ?string  $stepResolverHash
     * @phpstan-pure
     */
    public function __construct(ThrottleControlsMetadataResponseDto $controls, array $variables, string $stepId, string $id, string $name, string $slug, StepTypeEnum $type, ResourceOriginEnum $origin, string $workflowId, string $workflowDatabaseId, ?ThrottleStepResponseDtoControlValues $controlValues = null, ?StepIssuesDto $issues = null, ?string $stepResolverHash = null)
    {

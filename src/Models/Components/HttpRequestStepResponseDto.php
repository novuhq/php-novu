...
class HttpRequestStepResponseDto
{
     ...
     *
     * @var HttpRequestControlsMetadataResponseDto $controls
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controls')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\HttpRequestControlsMetadataResponseDto')]
    public HttpRequestControlsMetadataResponseDto $controls;
     ...
     *
     * @var ?HttpRequestStepResponseDtoControlValues $controlValues
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controlValues')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\HttpRequestStepResponseDtoControlValues|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?HttpRequestStepResponseDtoControlValues $controlValues = null;
    ...
    /**
     * @param  HttpRequestControlsMetadataResponseDto  $controls
     ...
     * @param  ?HttpRequestStepResponseDtoControlValues  $controlValues
     * @param  ?StepIssuesDto  $issues
     * @param  ?string  $stepResolverHash
     * @phpstan-pure
     */
    public function __construct(HttpRequestControlsMetadataResponseDto $controls, array $variables, string $stepId, string $id, string $name, string $slug, StepTypeEnum $type, ResourceOriginEnum $origin, string $workflowId, string $workflowDatabaseId, ?HttpRequestStepResponseDtoControlValues $controlValues = null, ?StepIssuesDto $issues = null, ?string $stepResolverHash = null)
    {

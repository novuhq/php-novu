...
class ToolStepResponseDto
{
    /**
     * Controls metadata for the tool step
     *
     * @var \novu\Models\Components\ToolControlsMetadataResponseDto $controls
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controls')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\ToolControlsMetadataResponseDto')]
    public ToolControlsMetadataResponseDto $controls;
     ...
     *
     * @var ?\novu\Models\Components\ToolStepResponseDtoControlValues $controlValues
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controlValues')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\ToolStepResponseDtoControlValues|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?ToolStepResponseDtoControlValues $controlValues = null;
     ...
     * @phpstan-pure
     */
    public function __construct(ToolControlsMetadataResponseDto $controls, array $variables, string $stepId, string $id, string $name, string $slug, StepTypeEnum $type, ResourceOriginEnum $origin, string $workflowId, string $workflowDatabaseId, ?ToolStepResponseDtoControlValues $controlValues = null, ?StepIssuesDto $issues = null, ?string $stepResolverHash = null, ?array $providerOverrides = null)
    {

...
class EmailStepResponseDto
{
     ...
     *
     * @var EmailControlsMetadataResponseDto $controls
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controls')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\EmailControlsMetadataResponseDto')]
    public EmailControlsMetadataResponseDto $controls;
     ...
     * Slug of the step
     *
     * @var EmailStepResponseDtoSlug $slug
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('slug')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\EmailStepResponseDtoSlug')]
    public EmailStepResponseDtoSlug $slug;
     ...
     *
     * @var ?EmailStepResponseDtoControlValues $controlValues
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controlValues')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\EmailStepResponseDtoControlValues|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?EmailStepResponseDtoControlValues $controlValues = null;
    ...
    /**
     * @param  EmailControlsMetadataResponseDto  $controls
     * @param  array<string, mixed>  $variables
     * @param  string  $stepId
     * @param  string  $id
     * @param  string  $name
     * @param  EmailStepResponseDtoSlug  $slug
     * @param  StepTypeEnum  $type
     * @param  WorkflowOriginEnum  $origin
     * @param  string  $workflowId
     * @param  string  $workflowDatabaseId
     * @param  ?EmailStepResponseDtoControlValues  $controlValues
     * @param  ?StepIssuesDto  $issues
     * @phpstan-pure
     */
    public function __construct(EmailControlsMetadataResponseDto $controls, array $variables, string $stepId, string $id, string $name, EmailStepResponseDtoSlug $slug, StepTypeEnum $type, WorkflowOriginEnum $origin, string $workflowId, string $workflowDatabaseId, ?EmailStepResponseDtoControlValues $controlValues = null, ?StepIssuesDto $issues = null)
    {

...
class InAppStepUpsertDto
{
     ...
     *
     * @var \novu\Models\Components\InAppControlDto|array<string, mixed>|null $controlValues
     */
     ...
     * @phpstan-pure
     */
    public function __construct(string $name, StepTypeEnum $type, ?string $id = null, ?string $stepId = null, InAppControlDto|array|null $controlValues = null)
    {
        $this->name = $name;
        $this->type = $type;
        $this->id = $id;

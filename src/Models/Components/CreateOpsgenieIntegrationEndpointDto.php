...
class CreateOpsgenieIntegrationEndpointDto
{
    /**
     ...
     *
     * @var \novu\Models\Components\CreateOpsgenieIntegrationEndpointDtoType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\CreateOpsgenieIntegrationEndpointDtoType')]
    public CreateOpsgenieIntegrationEndpointDtoType $type;
     ...
     *
     * @var \novu\Models\Components\OpsgenieIntegrationEndpointDto $endpoint
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('endpoint')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\OpsgenieIntegrationEndpointDto')]
    public OpsgenieIntegrationEndpointDto $endpoint;
     ...
     * $context
     *
     * @var ?array<string, string|\novu\Models\Components\CreateOpsgenieIntegrationEndpointDtoContext2> $context
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('context')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, string|\novu\Models\Components\CreateOpsgenieIntegrationEndpointDtoContext2>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateOpsgenieIntegrationEndpointDtoType $type, OpsgenieIntegrationEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

...
class CreateWebexPersonEndpointDto
{
    /**
     ...
     *
     * @var \novu\Models\Components\CreateWebexPersonEndpointDtoType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\CreateWebexPersonEndpointDtoType')]
    public CreateWebexPersonEndpointDtoType $type;

    /**
     * Webex person endpoint data. Provide exactly one of personId or personEmail.
     *
     * @var \novu\Models\Components\WebexPersonEndpointDto $endpoint
     */
     ...
     * $context
     *
     * @var ?array<string, string|\novu\Models\Components\CreateWebexPersonEndpointDtoContext2> $context
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('context')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, string|\novu\Models\Components\CreateWebexPersonEndpointDtoContext2>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateWebexPersonEndpointDtoType $type, WebexPersonEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

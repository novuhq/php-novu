...
class HttpRequestStepResponseDtoControlValues
{
     ...
     * @phpstan-pure
     */
    public function __construct(HttpMethodEnum $method, string $url, string|array|null $body = null, ?array $responseBodySchema = null, ?bool $enforceSchemaValidation = null, ?bool $continueOnFailure = null, ?array $additionalProperties = null, ?array $headers = null)
    {
        $this->method = $method;
        $this->url = $url;

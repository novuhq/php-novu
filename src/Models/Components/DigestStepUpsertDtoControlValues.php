...
class DigestStepUpsertDtoControlValues
{
    /**
     ...
     *
     * @var ?DigestStepUpsertDtoType $type
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('type')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\DigestStepUpsertDtoType|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?DigestStepUpsertDtoType $type = null;
     ...
     *
     * @var ?DigestStepUpsertDtoUnit $unit
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('unit')]
    #[\Speakeasy\Serializer\Annotation\Type('\novu\Models\Components\DigestStepUpsertDtoUnit|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?DigestStepUpsertDtoUnit $unit = null;
     ...
     * @param  ?DigestStepUpsertDtoType  $type
     * @param  ?float  $amount
     * @param  ?DigestStepUpsertDtoUnit  $unit
     * @param  ?LookBackWindowDto  $lookBackWindow
     * @param  ?string  $cron
     * @param  ?string  $digestKey
     * @phpstan-pure
     */
    public function __construct(?array $skip = null, ?DigestStepUpsertDtoType $type = null, ?float $amount = null, ?DigestStepUpsertDtoUnit $unit = null, ?LookBackWindowDto $lookBackWindow = null, ?string $cron = null, ?string $digestKey = null)
    {
        $this->skip = $skip;
        $this->type = $type;
        $this->amount = $amount;

...
class CreateMsTeamsUserEndpointDto
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriberId, string $integrationIdentifier, CreateMsTeamsUserEndpointDtoType $type, MsTeamsUserEndpointDto $endpoint, ?string $identifier = null, ?array $context = null, ?string $connectionIdentifier = null, ?bool $createSubscriberIfMissing = false)
    {

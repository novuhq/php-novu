...
class NovuTopics
{
    ...
    public function list(Operations\SubscribersControllerListSubscriberTopicsRequest $request, ?Options $options = null): Operations\SubscribersControllerListSubscriberTopicsResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/subscribers/{subscriberId}/subscriptions', Operations\SubscribersControllerListSubscriberTopicsRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\SubscribersControllerListSubscriberTopicsRequest::class, $request, $urlOverride);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'SubscribersController_listSubscriberTopics', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\SubscribersControllerListSubscriberTopicsResponse(
